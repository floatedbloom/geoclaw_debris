...
`requirements.txt` in the top level directory contains a list of things you 
might want to pip install.  (Feel free to edit it to add or delete things
based on your needs.)  This file is used when building and deploying on Github.
...
Python module [venv](https://docs.python.org/3/library/venv.html).
    ...
    python -m pip install --upgrade -r /path/to/requirements.txt
...
Jupyter lab in this environment, the packates listed in requirements.txt
