...
from clawpack.visclaw import legend_tools, colormaps
...
#--------------------------
    ...
    depth_cmap = colormaps.make_colormap({0:[0,1,1], 1:[0,0,1]})
    ...
    #plotitem.plot_var = geoplot.surface_or_depth  # depth where intially dry
    plotitem.plot_var = geoplot.depth  # depth where intially dry
